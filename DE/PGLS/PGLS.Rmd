...
heat_cols <- c(gre,bla,yel)
my.colors <- c(colorRampPalette(colors = c(heat_cols[1], heat_cols[2]))(10), colorRampPalette(colors = c(heat_cols[2], heat_cols[3]))(10))
...
### Top 50 genes showing significant BW response (24 hour) using PGLS approach
These genes show the same type of expression pattern as cftr and aqp3. 
...
my.colors <- c(colorRampPalette(colors = c(heat_cols[1], heat_cols[2]))(20), colorRampPalette(colors = c(heat_cols[2], heat_cols[3]))(20))
