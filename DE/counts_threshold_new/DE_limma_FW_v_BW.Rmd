...
#write.table(ExpDesign,"C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/ExpDesign_FW_v_BW.txt",sep="\t",quote=FALSE, row.names = FALSE)
...
dim(counts.filt)
#write.table(counts.filt,"C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/exp.tsv",sep="\t",quote=FALSE)
...
dim(ann)
#write.table(ann,"C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/annotations.tsv",sep="\t",quote=FALSE)
...
#write.csv(tmp, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/normalized_counts.csv"), quote = F, row.names = F)
...
#write.csv(ann_salinity, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/DE_results/main_salinity.csv"), quote = F, row.names = T)
...
#write.csv(ann_physiology, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/DE_results/main_physiology.csv"), quote = F, row.names = T)
...
#write.csv(ann_clade, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/DE_results/main_clade.csv"), quote = F, row.names = T)
...
#write.csv(ann_threeway, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/DE_results/threeway.csv"), quote = F, row.names = T)
...
#write.csv(ann_salinity_clade_interaction, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/DE_results/salinity_clade_interaction.csv"), quote = F, row.names = T)
...
#write.csv(ann_salinity_physiology_interaction, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/DE_results/salinity_physiology_interaction.csv"), quote = F, row.names = T)
...
#write.csv(ann_clade_physiology_interaction, file = file.path("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/counts_threshold_new/DE_limma_FW_v_BW/DE_results/clade_physiology_interaction.csv"), quote = F, row.names = T)
