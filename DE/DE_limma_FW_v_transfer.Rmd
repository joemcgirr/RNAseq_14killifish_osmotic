...
meta <- read.table("C:/Users/jmcgirr/Documents/GitHub/RNAseq_17killifish_osmotic/DE/ExpDesign.txt",stringsAsFactors = FALSE, header = TRUE)
...
#write.csv(ann_salinity, file = file.path("C:/Users/jmcgirr/Documents/Whitehead_Lab/fun/DE/DE_limma_FW_v_transfer/DE_results/main_transfer.csv"), quote = F, row.names = T)
...
#write.csv(ann_physiology, file = file.path("C:/Users/jmcgirr/Documents/Whitehead_Lab/fun/DE/DE_limma_FW_v_transfer/DE_results/main_physiology.csv"), quote = F, row.names = T)
...
#write.csv(ann_clade, file = file.path("C:/Users/jmcgirr/Documents/Whitehead_Lab/fun/DE/DE_limma_FW_v_transfer/DE_results/main_clade.csv"), quote = F, row.names = T)
...
#write.csv(ann_threeway, file = file.path("C:/Users/jmcgirr/Documents/Whitehead_Lab/fun/DE/DE_limma_FW_v_transfer/DE_results/threeway.csv"), quote = F, row.names = T)
...
#write.csv(ann_salinity_clade_interaction, file = file.path("C:/Users/jmcgirr/Documents/Whitehead_Lab/fun/DE/DE_limma_FW_v_transfer/DE_results/transfer_clade_interaction.csv"), quote = F, row.names = T)
...
#write.csv(ann_salinity_physiology_interaction, file = file.path("C:/Users/jmcgirr/Documents/Whitehead_Lab/fun/DE/DE_limma_FW_v_transfer/DE_results/transfer_physiology_interaction.csv"), quote = F, row.names = T)
...
#write.csv(ann_clade_physiology_interaction, file = file.path("C:/Users/jmcgirr/Documents/Whitehead_Lab/fun/DE/DE_limma_FW_v_transfer/DE_results/clade_physiology_interaction.csv"), quote = F, row.names = T)
...
## confirm DE patterns visually with normalized counts
